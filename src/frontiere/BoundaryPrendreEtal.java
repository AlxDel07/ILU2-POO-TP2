...
public class BoundaryPrendreEtal {
	...
	public void prendreEtal(String nomVendeur) {
		...
		if(!nomVendeurConnu) {
			...
			System.out.println("Bonjour " + nomVendeur + " je vais oir si je peux vous trouver un étal libre");
			boolean etalDisponible = controlPrendreEtal.resteEtals();
			if(!etalDisponible) {
				System.out.println("Désolée " + nomVendeur + "je n'ai plus d'étal libre");
			}else {
